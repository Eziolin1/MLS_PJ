...
def arg_parse():
    ...
    parser.add_argument('--target', type=str, default='0', help='target attack or not')
    args = parser.parse_args()
    args.opt_path = os.path.join(BASE_ADV_PATH, 'model_{}-method_{}-{}-{}'.format(args.model_name, args.attack, args.filename_prefix, args.target))
...
if __name__ == '__main__':
    ...
    if args.target == '1':
        target = True
    attack_method = getattr(our_method, args.attack)(args.model_name, target)
